              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-green-700">
                    Found {results.data?.potentialCustomers?.length || 0}{" "}
                    potential leads
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-gray-600 bg-gray-50 p-3 rounded-lg">
                    {results.data?.industry || "Not provided"}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 bg-gray-50 p-3 rounded-lg">
                    {results.data?.targetCustomerProfile || "Not provided"}
                  </p>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <p className="text-gray-600 bg-gray-50 p-4 rounded-lg">
                  {results.data?.companyDescription || "Not provided"}
                </p>
              </div>

              {/* Additional Info for Detailed Analysis */}
              {isDetailedResponse(results) && results.additionalInfo && (
                <div className="mt-6 pt-6 border-t">
                  <h3 className="font-semibold text-gray-700 mb-4">
                    Additional Insights
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {results.additionalInfo.companyName && (
                      <div>
                    ...
                    {results.additionalInfo.keyProducts &&
                      results.additionalInfo.keyProducts.length > 0 && (
                        <div>
                    ...
                    {results.additionalInfo.competitors &&
                      results.additionalInfo.competitors.length > 0 && (
              ...
              results.data.potentialCustomers.length > 0 ? (
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  {results.data.potentialCustomers.map(
                    (customer: CustomerLead, index: number) => (
                      <div
                        key={`customer-${index}`}
